 ...
 * 
 */
@WebServiceClient(name = "ServicesService", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8090/ws/SOAPServerInterface?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICESSERVICE_QNAME = new QName("http://ws/", "ServicesService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8090/ws/SOAPServerInterface?wsdl");
    ...
    public SOAPServerInterface getServicesPort() {
        return super.getPort(new QName("http://ws/", "ServicesPort"), SOAPServerInterface.class);
    }
    ...
    public SOAPServerInterface getServicesPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "ServicesPort"), SOAPServerInterface.class, features);
    }
